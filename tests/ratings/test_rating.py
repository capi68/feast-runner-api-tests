...
class TestRatingsCreation(BaseAssertions):
    ...
    def test_create_rating_success(self,rating_service, delivered_order):
    ...
    def test_create_rating_out_of_rage_food_score(self,rating_service, delivered_order):
    ...
    def test_create_rating_out_rage_delivery_score(self,rating_service, delivered_order):
    ...
    def test_create_rating_missing_fields(self,rating_service):
    ...
    @allure.story("Create rating with nonexistent order")
    def test_create_rating_nonexistent_order(self,rating_service):
        """POST /ratings with order 999999 should return 404 and message."""

        rating = Rating(order_id=999999)
        payload = rating_create_payload(rating, delivery_score=5)
        response = rating_service.create(payload)
    ...
    def test_create_rating_comment_exceeds_max_length(self,rating_service, delivered_order):
    ...
    def test_create_rating_order_already_rated(self,rating_service, delivered_order):
    ...
    def test_create_rating_empty_required_fields(self,delivered_order,rating_service,field):
...
class TestRatingRetrieval(BaseAssertions):
    ...
    def test_get_by_id(self,rating_service,delivered_order):
    ...
    def test_get_by_id_not_found(self, rating_service,):
        """GET /ratings/999999 - should return 404 with message."""
    ...
    def test_get_list_filtered_by_order_id(self,rating_service,delivered_order):
